...
import com.example.slgm.dao.Henseikouseidao;
import com.example.slgm.entity.Henseit;
import com.example.slgm.entity.Unitkousei;

@SuppressWarnings("serial")
@Repository
public class FindhenseikouseiRepository implements Henseikouseidao {
	
    @Autowired
    private EntityManager entityManager;

    public FindhenseikouseiRepository() {
        super();
    }

    public FindhenseikouseiRepository(EntityManager manager) {
        this();
