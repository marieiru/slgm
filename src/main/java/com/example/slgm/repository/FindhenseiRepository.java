...
import com.example.slgm.dao.Henseijyouhoudao;
import com.example.slgm.entity.Henseit;


@SuppressWarnings("serial")
@Repository
public class FindhenseiRepository implements Henseijyouhoudao {

	   @Autowired
	    private EntityManager entityManager;

	    public FindhenseiRepository() {
	        super();
	    }

	    public FindhenseiRepository(EntityManager manager) {
	        this();
